...
export default function Showcase() {
    ...
    return (
        <Layout title={"Showcase"} description={siteConfig.tagline} keywords={siteConfig.customFields.keywords} metaImage={useBaseUrl(`img/${siteConfig.customFields.image}`)} wrapperClassName={"page-showcase"}>
