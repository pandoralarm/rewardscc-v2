...
export default function Home() {
    ...
    return (
        <Layout title={siteConfig.title} description={siteConfig.tagline} keywords={siteConfig.customFields.keywords} metaImage={useBaseUrl(`img/${siteConfig.customFields.image}`)} wrapperClassName={"page-home"}>
            <Intro />
            <Why />
            <GetStarted />
            <Features />
